...
internal object ConfigSections {
     ...
     * display name.
     */
    val explicitSections: Map<String, Map<String, List<Pair<String, Set<String>>>>> = mapOf(
        "render" to mapOf(
            "misc" to listOf(
    ...
    val linkSections: Map<String, Map<String, List<LinkTarget>>> = mapOf(
        "farming" to mapOf(
     ...
     */
    val actionRows: Map<String, Map<String, List<ActionRowSpec>>> = mapOf(
        "dev" to mapOf(
            "config" to listOf(
                ActionRowSpec(
    ...
    val virtualSubs: Map<String, List<String>> = mapOf(
    ...
    val optionVisibility: Map<String, () -> Boolean> = mapOf(
    ...
    val rebuildOnChange: Set<String> = setOf(
    ...
    val keybindOptions: Set<String> = setOf(
